...
\begin{triangles}
  \item Largest RSA challenge$^*$ factored had $829$ bits (2020).
  \item Largest number factored using quantum annealing is 8,219,999 (2024). 
  ...
  \item Shor's algoritm factored $21$ on quantum computer with 27Qbits (2021).
