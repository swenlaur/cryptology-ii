...
A protocol is $(\tre,f(\cdot),\varepsilon)$-\emph{secure} if for any
$\tre$-time real world adversary $\AD$ there exists a $f(\tre)$-time
...
A protocol is $(\tre,f(\cdot),\tpre,\varepsilon)$-\emph{secure} if for
any $\tre$-time real world adversary $\AD$ there exists a $f(\tre)$-time
ideal world adversary $\ADID$ such that for any input distribution
$\INPDIST$ the output distributions $\vec{\OSTATE}$ and
